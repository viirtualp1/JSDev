      ...
      switch (skill) {
        case 'conditions':
          document.getElementById(
            `${this.skillInput}`,
          ).innerHTML += `<i class="fas fa-pen text-primary edit" onclick="showEditSkill('${skill}', '${this.skillInput}', '${this.conditionsIndex}')"></i>`;
        ...
        case 'requirements':
          document.getElementById(
            `${this.skillInput}`,
          ).innerHTML += `<i class="fas fa-pen text-primary edit" onclick="showEditSkill('${skill}', '${this.skillInput}', '${this.requirementsIndex}')"></i>`;
        ...
        case 'responsibilities':
          document.getElementById(
            `${this.skillInput}`,
          ).innerHTML += `<i class="fas fa-pen text-primary edit" onclick="showEditSkill('${skill}', '${this.skillInput}', '${this.responsibilitiesIndex}')"></i>`;
...
function editSkill(skill, index, value) {
  ...
  switch (skill) {
    case 'conditions':
      ...
      document.getElementById(
        `${editInput}`,
      ).innerHTML = `${editInput} <i class="fas fa-pen text-primary edit" onclick="showEditSkill('${skill}', '${editInput}', '${index}')"></i>`;
